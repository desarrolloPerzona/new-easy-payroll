...
class CreateIsrDailyRetentionSubsidiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('isr_daily_retention_subsidies', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('isr_daily_retention_subsidies');
    }
}
