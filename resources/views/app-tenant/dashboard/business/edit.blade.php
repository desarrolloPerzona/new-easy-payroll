<x-app-tenant>
    <div class="container mx-auto">
        <h2 class="bg-blueSteel py-2 px-3 mb-2 rounded">
            ...
            <span style="display: inline-flex;">{{ __('Edit business') }}</span>
        </h2>
        ...
        <div class="card bg-white shadow-sm rounded p-4 max-w-6xl my-2 mx-auto">
            ...
            <input class="text-gray-800 rounded my-2" type="text" id="name" name="Name" placeholder="Perzona">
            ...
            <input class="text-gray-800 rounded my-2" type="text" id="name" name="Name" placeholder="RRHH">
            ...
            <input class="text-gray-800 rounded my-2" type="text" id="name" name="Name" placeholder="PERZ02369856">


            <div class="flex-1 text-left py-2"><label class="font-bold" for="name">{{__('Adress')}}</label></div>
            <input class="text-gray-800 rounded my-2" type="text" id="name" name="Name" placeholder="Bosques de Tamarindos. 135 piso 2, Col. Aguabrav">

            <div class="flex-1 text-left py-2"><label class="font-bold" for="name">{{__('State')}}</label></div>
            <input class="text-gray-800 rounded my-2" type="text" id="name" name="Name" placeholder="CDMX">
