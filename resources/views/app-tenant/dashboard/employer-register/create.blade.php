...
{{--        Nombre--------------}}
        <div class="card bg-white shadow-sm rounded p-4 max-w-6xl my-2 mx-auto dark:bg-dark dark:text-white">
            ...
            <form action="{{ route('employer-register.store') }}" method="POST">
                ...
                <input class="text-gray-800 rounded my-2 dark:bg-dark dark:text-white w-100" type="text" id="name" name="name">
                {{--            Prima de riesgo--------------}}
                <label class="font-bold " for="name">{{__('Risk premium')}}</label>
                <input class="text-gray-800 rounded my-2 dark:bg-dark dark:text-white w-100" type="text" id="risk_premium" name="risk_premium">
                {{--            Clave subdelegacional IMSS--------------}}
                <label class="font-bold" for="name">{{__('IMSS subdelegational key')}}</label>
                <input class="text-gray-800 rounded my-2 dark:bg-dark dark:text-white w-100" type="text" id="imss_sub_delegation_key" name="imss_sub_delegation_key">
