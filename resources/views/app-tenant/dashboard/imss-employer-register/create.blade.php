<x-app-tenant>
    <div class="container mx-auto">
        ...
        <div class="card bg-white shadow-sm rounded p-4 my-2 mx-auto dark:bg-dark dark:text-white">
            ...
            <form class="form-group" action="{{route('imss-employer-registers.store')}}" method="POST">
                @csrf
                ...
                <div class="form-group d-flex justify-content-between gap-3">
                    ...
                    <div class="w-100">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-main-input" placeholder="Alias">
                    </div>
                ...
                <div class="form-group d-flex justify-content-between gap-3">
                    <div class="w-50">
                        ...
                        <input type="number" step=".001" id="risk_premium" name="risk_premium" class="form-control form-main-input" placeholder="1.3">
                    </div>
                    <div class="w-100">
                        <label for="imss_sub_delegation_key" class="font-bold mb-2">{{__('IMSS subdelegational key')}} <span class="text-danger">*</span></label>
                        <input type="text" id="imss_sub_delegation_key" name="imss_sub_delegation_key" class="form-control form-main-input" placeholder="8826398826">
                    </div>
                </div>
