        ...
        <div class="form-group d-flex justify-content-between">
            <div class="w-75 mr-2">
                ...
                <select id="branch" name="branch"
                    ...
                    <option value="">{{__($bankAccount->business->name)}}</option>
                    @foreach($businesses as $business)
                        @if($bankAccount->business->name != $business->name)
            ...
            <div class="w-50 ms-2">
                ...
                <select id="institutional_key" name="institutional_key"
                    ...
                    @foreach($banks as $bank)
                        @if($bankAccount->institutional_key == $bank->institutional_key)
        ...
        <div class="form-group d-flex justify-content-between">
            <div class="w-100 mb-2">
                ...
                <textarea type="text" id="description" name="description" class="form-control form-main-input"
                          ...
                          rows="1">{{ $bankAccount->description }}</textarea>
            </div>
        </div>
        <div class="form-group d-flex justify-content-between">
            <div class="w-1/3 pe-2">
                ...
                <input id="information_number" name="information_number" class="w-100 form-control"
                       type="number" placeholder="009273" value="{{ $bankAccount->information_number }}">
            </div>
            <div class="w-1/3 px-2">
                ...
                <input id="branch_number" name="branch_number" class="w-100 form-control" type="number"
                       value="{{ $bankAccount->branch_number }}" placeholder="77384">
            </div>
            <div class="w-1/3 ps-2">
                ...
                <input id="account_clabe" name="account_clabe" class="w-100 form-control" type="number"
                       value="{{ $bankAccount->account_clabe }}" placeholder="0388492764883">
            </div>
        </div>
