<div class="card bg-white shadow-sm rounded p-4 my-2 mx-auto dark:bg-dark dark:text-white">
    ...
    <form class="form-group"
        ...
        <div class="form-group lg:flex-col md:flex-row">
            <div class="mb-2">
                <label for="name" class="font-bold form-label mb-2">{{__('Name')}} <span
            ...
            <div class="mb-2">
                <label for="branch" class="font-bold form-label mb-2">{{__('Branch')}} <span
                        class="text-danger">*</span></label>
                <select
                    id="branch"
                    name="branch"
            ...
            <div class="accordion" id="certAccordion">
                ...
                <div class="accordion-item">
                    <div class="accordion-header mr-4" id="headingOne">
                        <button type="button" data-bs-toggle="collapse" data-bs-target="#collapseImss"
                                aria-expanded="true" aria-controls="collapseTwo">
                            <div class="my-3 mx-2">
                                <input type="radio" id="use_imss" name="use_cert" value="imss"
                                       wire:model.defer="use_cert">
                            </div>
                ...
                <div class="accordion-item">
                    <div class="accordion-header mr-4" id="headingFiel">
                        <button type="button" data-bs-toggle="collapse" data-bs-target="#collapseFiel"
                            ...
                            <div class="my-3 mx-2">
                                <input type="radio" id="use_fiel" name="use_cert" value="fiel"
                                       wire:model.defer="use_cert">
                            </div>
