<x-app-tenant>
    <div class="container mx-auto">
        ...
        <div class="card bg-white shadow-sm rounded p-4 max-w-6xl my-2 mx-auto">
            ...
            <lavel for="name">Prima de riesgo</lavel>
            <input class="text-gray-800 rounded my-2" type="text" id="name" name="Name" placeholder="3">

            <lavel for="name">Clave subdelegfacional IMSS</lavel>
...
{{--            IMSS-------------------------------------}}
            ...
            <div class="my-3">
                <input type="radio" id="huey" name="drone" value="huey"
                       checked>
                <label for="huey">Enviar movimientos al IMSS mediante certificado IMSS</label>
            </div>


            <div class="flex flex-col flex-grow mb-3">

                <label class="my-2">Certificado IMSS</label>
            ...
            <lavel for="name">Usuario certificado IMSS</lavel>
            <input class="text-gray-800 rounded my-2" type="text" id="name" name="Name" placeholder="IMSS23695">

            <lavel for="name">Usuario certificado IMSS</lavel>
            <input class="text-gray-800 rounded my-2" type="password" id="name" name="Name" placeholder="••••••••••">
