                    ...
                    <div class="accordion-item">
                        <div class="accordion-header mr-4" id="headingOne">
                            <table class="table">
                                ...
                                <td style="width: 3%"><a href="{{route('workingdayholiday.edit',1)}}"> <i
                ...
                <div class="accordion-item bg-blueSteel py-2 px-3 mb-2 rounded">
                    <div class="accordion-header mr-4" id="headingOne">
                        ...
                        <div id="collapseP1" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body text-dark bg-gray-100 rounded">
                                <div>
                                    <div><label class="font-bold" for="name">{{__('Holiday name')}}</label></div>
                  ...
                  ></span>
                                    ...
                                    <div class="flex-1 text-center">
                                        ...
                                        <div>
                                            <input type="radio" id="allday" name="Si" value="Si" checked>
